    ...
    function listUserInfo(profile){
        ...
        $.ajax({
            ...
            success: function(r){
                ...
                generateUserProfile(type, obj[0].correo, obj[0].usuario, obj[0].nombres,obj[0].apellidos, obj[0].fecha_nacimiento, obj[0].genero, obj[0].pais, '../../assets/img/users/' + obj[0].name_img+"."+obj[0].formato_img, groups,groupNames,isfollow,wishes, ()=>{
                    for(i = 1; i < (obj.length - 1); i++){
